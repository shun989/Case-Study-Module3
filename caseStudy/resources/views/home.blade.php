    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="./">{{__('language.Home')}}</a></li>
            ...
            <form class="d-flex">
                <button class="btn btn-outline-dark" type="submit">
                    ...
                    <a class="to-cart" href="{{route('login')}}">{{__('language.Cart')}}</a>
                    <span class="badge bg-dark text-white ms-1 rounded-pill">0</span>
                </button>
            </form>
            <a class="auth-user" href="{{route('login')}}">{{__('language.Login')}}</a><span>|</span>
            <a class="auth-user" href="{{route('register')}}">{{__('language.Register')}}</a>
        </div>
    </div>
</nav>
<!-- Header-->
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('login')}}">{{__('Add to cart')}}</a></div>
                        </div>
                    </div>
                </div>
            @endforeach
